...
The B<Dancer::Forms> module provides a comfortable way to maintain
...
B<Dancer::Forms> aims to behave as much as B<Django's> Forms system
...
you can then put out the generated form. B<Dancer::Forms> will
...
To create a form, you have to instanciate an B<Dancer::Forms> object.
...
module, how this works. B<Dancer::Forms> will just pass
...
B<Dancer::Forms> how to do the mentioned things above and
more.
...
the whole meta parameter, B<Dancer::Forms> will generate it itself
...
If you omit the B<meta> parameter at all, B<Dancer::Forms> will
...
Instead of letting Dancer::Forms do the rendering of the form,
...
Usually B<Dancer::Forms> generates the B<DFV Profile> used by the
...
B<Dancer::Forms> provides CSRF attack protection. Refer to
...
Since B<Dancer::Forms> doesn't depend on L<Dancer> (or any other
...
To debug Dancer::Forms use the Perl debugger, see L<perldebug>.

=head1 DEPENDENCIES

B<Dancer::Forms> depends on the module L<Data::FormValidator>.
